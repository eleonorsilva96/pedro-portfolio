...
export default function WhatsAppButton() {
  ...
  const phoneNumber = "+351932126365"; // Format: CountryCode + Number (no + or 00)
  const message = "Olá! Tenho interesse no seu trabalho e gostaria de conversar."; // Optional pre-filled message
